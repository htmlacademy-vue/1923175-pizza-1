...
export const NEW_ADDRESS_SET_STREET = "NEW_ADDRESS_SET_STREET";
export const NEW_ADDRESS_SET_BUILDING = "NEW_ADDRESS_SET_BUILDING";
export const NEW_ADDRESS_SET_FLAT = "NEW_ADDRESS_SET_FLAT";
